...
static bool js_renderer_MaskAssembler_setBeginMask(se::State& s)
{
	cocos2d::renderer::MaskAssembler* cobj = (cocos2d::renderer::MaskAssembler*)s.nativeThisObject();
	SE_PRECONDITION2(cobj, false, "js_renderer_MaskAssembler_setBeginMask : Invalid Native Object");
	const auto& args = s.args();
	size_t argc = args.size();
	CC_UNUSED bool ok = true;
	if (argc == 1) {
		bool arg0;
		ok &= seval_to_boolean(args[0], &arg0);
		SE_PRECONDITION2(ok, false, "js_renderer_MaskAssembler_setBeginMask : Error processing arguments");
		cobj->setBeginMask(arg0);
		return true;
	}
	SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
	return false;
}
SE_BIND_FUNC(js_renderer_MaskAssembler_setBeginMask)

static bool js_renderer_MaskAssembler_setEndMask(se::State& s)
{
	cocos2d::renderer::MaskAssembler* cobj = (cocos2d::renderer::MaskAssembler*)s.nativeThisObject();
	SE_PRECONDITION2(cobj, false, "js_renderer_MaskAssembler_setEndMask : Invalid Native Object");
	const auto& args = s.args();
	size_t argc = args.size();
	CC_UNUSED bool ok = true;
	if (argc == 1) {
		bool arg0;
		ok &= seval_to_boolean(args[0], &arg0);
		SE_PRECONDITION2(ok, false, "js_renderer_MaskAssembler_setEndMask : Error processing arguments");
		cobj->setEndMask(arg0);
		return true;
	}
	SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
	return false;
}
SE_BIND_FUNC(js_renderer_MaskAssembler_setEndMask)
...
bool js_register_renderer_MaskAssembler(se::Object* obj)
{
	...
	cls->defineFunction("setBeginMask", _SE(js_renderer_MaskAssembler_setBeginMask));
	cls->defineFunction("setEndMask", _SE(js_renderer_MaskAssembler_setEndMask));
